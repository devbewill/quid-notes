  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-surface border border-border rounded-2xl p-8 w-full max-w-sm mx-4 shadow-2xl"
      >
        <h2 className="text-base font-semibold mb-2">
          ⚠️ {t("delete_modal_title")}
        </h2>
        <p className="text-sm text-muted mb-6">{t("delete_modal_desc")}</p>
        ...
        <input
          ...
          className="w-full bg-bg border border-border rounded-lg px-3 py-2 text-sm text-text placeholder:text-muted outline-none focus:border-red-500 transition-colors mb-6"
        />
        ...
        <div className="flex gap-3 justify-end">
          ...
          <button
            ...
            className="text-sm font-semibold bg-red-600 text-white rounded-full px-5 py-1.5
